...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        String token = JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis() + jwtConfiguration.getExpirationTime()))
                .sign(HMAC512(jwtConfiguration.getSecret().getBytes()));
        res.addHeader(jwtConfiguration.getHeader(), jwtConfiguration.getTokenPrefix() + token);
    }
